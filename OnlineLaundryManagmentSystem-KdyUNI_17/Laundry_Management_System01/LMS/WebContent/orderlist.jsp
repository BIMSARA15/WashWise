...
<body>
	...
	<% for(Order order : ordRec ){ %>
		<tr>
			...
			<td style="text-align:center"><%= order.getService() %></td>
			...
			<td style="text-align:center">
				<a href= "EditOrderServlet?orderId=<%= order.getOrderId()%>" class="myButtonBlue" title="Edit Order Details">Edit</a>
			</td>
			<td style="text-align:center">
				<a href= "DeleteOrderServlet?orderId=<%= order.getOrderId()%>" class="myButtonRed" title="Delete Order">Delete</a>
			</td>
		</tr>
	<% } %>
	</table>
