...
%>	
    ...
    <td>
        <select name="service" required>
            <option value="wash" <%= "wash".equals(order.getService()) ? "selected" : "" %>>Wash</option>
            <option value="dry" <%= "dry".equals(order.getService()) ? "selected" : "" %>>Dry</option>
            <option value="iron" <%= "iron".equals(order.getService()) ? "selected" : "" %>>Iron</option>
            <option value="dryClean" <%= "dryClean".equals(order.getService()) ? "selected" : "" %>>Dry Clean</option>
        </select>
    </td>
</tr>
