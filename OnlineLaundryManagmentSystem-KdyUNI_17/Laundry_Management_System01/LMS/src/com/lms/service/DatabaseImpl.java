...
public class DatabaseImpl implements Database {
 ...
 // Add this method to your DatabaseImpl class
    public ArrayList<Delivery> getAllDeliveries() throws SQLException {
        ...
        try (Connection connection = getConnection();
            ...
            while (resultSet.next()) {
                ...
                int deliveryType = resultSet.getInt("deliveryTypeId");
                int orderId = resultSet.getInt("orderId");
                
                Delivery delivery = new Delivery(orderId, deliveryId, location, phoneNo, email, deliveryType);
